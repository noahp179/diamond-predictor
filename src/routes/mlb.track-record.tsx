...
function HistoryPage() {
  ...
  return (
    <AppShell
      sport="mlb"
      view="trackRecord"
      eyebrow={`Track Record · tracking since ${trackingSince}`}
      title="Box Score"
      blurb={`Every model we run — the Poisson analytic model, the recent-form and bullpen sims, the calibrated and headline Simulator, the market blend and the devigged market line — scored identically on every settled game. A clean start: all lines begin together at ${trackingSince}.`}
